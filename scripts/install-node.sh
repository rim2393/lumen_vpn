...
main() {
  ...
  LUMEN_NODE_AGENT_IMAGE="${NODE_AGENT_IMAGE:-${LUMEN_NODE_AGENT_IMAGE:-ghcr.io/rim2393/lumen-node-agent:v0.1.8@sha256:cf85f98764ef24ca36e41be5e66b4f93fd631a108c9b206edeb88c3d45cd7ea7}}"

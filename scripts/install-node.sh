...
main() {
  ...
  LUMEN_NODE_AGENT_IMAGE="${NODE_AGENT_IMAGE:-${LUMEN_NODE_AGENT_IMAGE:-ghcr.io/rim2393/lumen-node-agent:v0.1.6@sha256:5d8dc73c8de0203553d9acdf0a9e2d3393c4bb91d0d982db27a6f33510c1f6bb}}"

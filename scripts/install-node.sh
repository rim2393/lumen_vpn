...
main() {
  ...
  LUMEN_NODE_AGENT_IMAGE="${NODE_AGENT_IMAGE:-${LUMEN_NODE_AGENT_IMAGE:-ghcr.io/rim2393/lumen-node-agent:v0.1.7@sha256:6eb431f5cfc618deffb9372ce85c81af0b7974977314ed683a9adb9ac31a929c}}"
